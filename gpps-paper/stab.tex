...
passage calculation.
The flow solution {\color{red} corresponding to the
left most point o the whole annulus performance curve} is shown in Fig.~\ref{fig:r67-flow}.
%No mesh convergence study has been performed due to the time constraint.
...
When the flow has fully converged, the left most point on the whole-annulus
